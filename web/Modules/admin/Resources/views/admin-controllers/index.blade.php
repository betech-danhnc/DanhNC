...
<div class="row">
    <div class="col-md-12">
        <!-- DATA TABLE -->
        <h3 class="title-5 m-b-35">List Controller in admin</h3>
        <div class="table-data__tool">
            ...
            <div class="table-data__tool-right">
                <a class="btn btn-success" href="{{ route('admin-controllers.create') }}"><i class="zmdi zmdi-plus"></i> Create New Module</a>
